...
public class JsonWriterTest extends JsonTest {
    ...
    void testWriterGeneralPracticeLog() {
        try {
            PracticeLog pl = new PracticeLog();
            pl.addSession(new PracticeSession("2025-10-18", "piano", "Valse", 
                    90, "technique", "Romantic", "improve left hand"));
            pl.addSession(new PracticeSession("2025-10-19", "guitar", "2-part invension", 
                    120, "not a good practice", "Baroque", "n/a"));
            ...
            checkPracticeSession("2025-10-18", "piano", "Valse", 
                    90, "technique", "Romantic", "improve left hand", practiceSessions.get(0));
            checkPracticeSession("2025-10-19", "guitar", "2-part invension", 
                    120, "not a good practice", "Baroque", "n/a", practiceSessions.get(1));
